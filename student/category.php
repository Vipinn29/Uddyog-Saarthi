...
<body>
    ...
    <div class="card-group" style="margin-left: 250px; display: flex;">
          ...
          <div class="card" style="width: 400px; border: none;" align="center">
            <img src="../images/it.png" class="card-img-top" alt="..." style="width: 200px;">
            <div class="card-body">
          ...
          <div class="card" style="width: 400px; border: none;" align="center">
            <img src="../images/bpo.png" class="card-img-top" alt="..." style="width: 200px;">
            <div class="card-body">
          ...
          <!-- <a href="applybpo.php" class="btn btn-light"> -->
          <div class="card" style="width: 400px; border: none;" align="center">
            <img src="https://th.bing.com/th/id/OIP.BzBeSCSxWzY3-8KqpWnchwHaKu?w=119&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" class="card-img-top" alt="..." style="width: 200px;">
            <div class="card-body">
              <br><h2 class="card-title" align="center">SEWING CLOTH at home</h5>
              <p class="card-text"><small class="text-muted">Providing near your home coaches for sewing</small></p>
            </div>
          </div>
          </a>
      </div>
          ...
          <!-- <a href="applybpo.php" class="btn btn-light"> -->
          <div class="card" style="width: 400px; border: none;" align="center">
            <img src="" class="card-img-top" alt="..." style="width: 400px;">
            <div class="card-body">
              <br><h2 class="card-title" align="center">More --></h5>
