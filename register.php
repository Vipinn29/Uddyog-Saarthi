...
<body>
    ...
    <div class="content" style="margin-top: 20px; margin-left: -40px;">
    	<h1 class="form-row justify-content-center" style="margin-left: 60px;"> USER  SIGN-UP</h1> <br>
		      ...
		      <div class="center one">
		        <div class="form-row">
		        	<div class="form-group col-md-5">
			          <label for="cid">Physcial handicap Id</label>
			          <input type="text" class="form-control" id="cid" name="cid" placeholder="Handicap ID">
			        </div>
			        <div class="form-group col-md-5">
		        ...
		        <div class="form-row">
			        <div class="form-group col-md-5">
			          <label for="exampleInputEmail1">Which type of disability you are</label>
			          <select class="form-control" name="secque" required>
			          	<option>Blindness</option>
			          	<option>Deaf</option>
			          	<option>Person with low vision </option>
			          	<option>Dyslexia</option>
			          	<option>Rehabination</option>
			          	<option>Other</option>
			          </select>
			        </div>
		        	<div class="form-group col-md-5">
			          <label for="telephone">Your favourite singer </label>
